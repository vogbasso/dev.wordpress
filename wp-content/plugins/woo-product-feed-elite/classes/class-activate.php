...
class WooSEA_Activation {
	...
	public static function activate_checks() {
		...
		update_option( 'channel_statics', $channel_statics,'no');
        	...
        	// Check if we need to disable the free version first
        	if(is_plugin_active( 'woo-product-feed-pro/woocommerce-sea.php' )) {
                	deactivate_plugins( 'woo-product-feed-pro/woocommerce-sea.php' );
        	}
