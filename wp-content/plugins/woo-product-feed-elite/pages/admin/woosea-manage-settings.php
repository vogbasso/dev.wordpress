...
$header_text = __( 'Plugin settings', 'woo-product-feed-elite' );
if(isset($_GET["tab"])) {
	if($_GET["tab"] == "woosea_manage_settings"){
		...
		$header_text = __( 'Plugin systems check', 'woo-product-feed-elite' );
	} elseif ($_GET["tab"] == "woosea_copy_configs"){
        	$active_tab = "woosea_copy_configs";
		$header_text = __( 'Copy feed configuration', 'woo-product-feed-elite' );
	} elseif ($_GET["tab"] == "woosea_license_check"){
        	$active_tab = "woosea_license_check";
		$header_text = __( 'License', 'woo-product-feed-elite' );
     	} else {
...
<div class="wrap">
        ...
        <div class="woo-product-feed-pro-form-style-2">
			...
			<h2 class="nav-tab-wrapper">
                		...
                		<a href="?page=woosea_elite_manage_settings&tab=woosea_manage_settings" class="nav-tab <?php if($active_tab == 'woosea_manage_settings'){echo 'nav-tab-active';} ?> "><?php _e('Plugin settings', 'woo-product-feed-elite'); ?></a>
                		<a href="?page=woosea_elite_manage_settings&tab=woosea_manage_attributes" class="nav-tab <?php if($active_tab == 'woosea_manage_attributes'){echo 'nav-tab-active';} ?>"><?php _e('Extra fields', 'woo-product-feed-elite'); ?></a>
                		<a href="?page=woosea_elite_manage_settings&tab=woosea_system_check" class="nav-tab <?php if($active_tab == 'woosea_system_check'){echo 'nav-tab-active';} ?>"><?php _e('Plugin systems check', 'woo-product-feed-elite'); ?></a>
				<a href="?page=woosea_elite_manage_settings&tab=woosea_license_check" class="nav-tab <?php if($active_tab == 'woosea_license_check'){echo 'nav-tab-active';} ?>"><?php _e('License', 'woo-product-feed-elite'); ?></a>
	  		</h2>
