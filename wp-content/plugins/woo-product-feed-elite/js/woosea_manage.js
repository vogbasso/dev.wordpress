jQuery(document).ready(function($) {
  	...
  	if (get_value == 'woosea_manage_feed') {
		$(document).on('ready',function(){
                        ...
                        jQuery.ajax({
                                method: "POST",
                                url: ajaxurl,
                                data: { 'action': 'woosea_elite_check_processing' }
                        })
                        .done(function( data ) {
	...
	$(".dismiss-review-notification").click(function(){
	        ...
	        jQuery.ajax({
                	method: "POST",
                        url: ajaxurl,
                        data: { 'action': 'woosea_elite_review_notification' }
                })
	...
	$(".license_notification").click(function(){
		$(".license_notification").remove();	
	        ...
	        jQuery.ajax({
                	method: "POST",
                        url: ajaxurl,
                        data: { 'action': 'woosea_elite_license_notification' }
                })
	});
	...
	$(".get_elite").click(function(e){
		...
		$(".get_elite").remove();	
	        ...
	        jQuery.ajax({
                	method: "POST",
                        url: ajaxurl,
                        data: { 'action': 'woosea_elite_getelite_notification' }
                })
	});
	...
	$(".get_elite_activate").click(function(e){
		...
		$(".get_elite_activate").remove();	
	        ...
	        jQuery.ajax({
                	method: "POST",
                        url: ajaxurl,
                        data: { 'action': 'woosea_elite_getelite_active_notification' }
                })
	});
	...
	$('.checkbox-field').change(function(index, obj){
		...
		if(get_value == 'woosea_elite_manage_settings' && tab_value == 'woosea_manage_attributes'){
			...
			var attribute_status = $(this).prop("checked");
	                ...
	                jQuery.ajax({
 		               	method: "POST",
               	         	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_attributes', 'attribute_name': attribute_name, 'attribute_value': attribute_value, 'active': attribute_status }
                	})
			...
			project_status = $(this).prop("checked");
	                ...
	                jQuery.ajax({
 		               	method: "POST",
               	         	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_project_status', 'project_hash': project_hash, 'active': project_status }
                	})
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_manipulation', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_manipulation', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_wpml', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_wpml', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_aelia', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_aelia', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_mother_image', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_mother_image', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_all_shipping', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_all_shipping', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_free_shipping', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_free_shipping', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_local_pickup_shipping', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_local_pickup_shipping', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_woosea_logging', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_woosea_logging', 'status': "off" }
                	})
		}
	})	
        ...
        $('#woosea_content_ids').on('change', function(){ // on change of state
                ...
                if(content_ids){
                        jQuery.ajax({
                                method: "POST",
                                url: ajaxurl,
                                data: { 'action': 'woosea_elite_facebook_content_ids', 'content_ids': content_ids }
                        })
                }
        })
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_facebook_pixel_setting', 'status': "on" }
                	})
			.done(function( data ) {
			...
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_facebook_pixel_setting', 'status': "off" }
                	})
			.done(function( data ) {
   		...
   		if(this.checked){
				...
				// Checkbox is on
        	        	jQuery.ajax({
                	        	method: "POST",
                        		url: ajaxurl,
                        		data: { 'action': 'woosea_elite_add_batch', 'status': "on" }
                		})
				.done(function( data ) {
			...
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_batch', 'status': "off" }
                	})
			.done(function( data ) {
		...
		var woosea_valid_batch_size=re.test(batch_size);
			...
			// Now we need to save the conversion ID so we can use it in the dynamic remarketing JS
                        jQuery.ajax({
                                method: "POST",
                                url: ajaxurl,
                                data: { 'action': 'woosea_elite_save_batch_size', 'batch_size': batch_size }
                        })
                }	
	})
   		...
   		if(this.checked){
			...
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_remarketing', 'status': "on" }
                	})
			.done(function( data ) {
			...
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_remarketing', 'status': "off" }
                	})
			.done(function( data ) {
		...
		var woosea_valid_conversion_id=re.test(adwords_conversion_id);
			...
			// Now we need to save the conversion ID so we can use it in the dynamic remarketing JS
                        jQuery.ajax({
                                method: "POST",
                                url: ajaxurl,
                                data: { 'action': 'woosea_elite_save_adwords_conversion_id', 'adwords_conversion_id': adwords_conversion_id }
                        })
                }	
	})
		...
		var woosea_valid_facebook_pixel_id=re.test(facebook_pixel_id);
			...
			// Now we need to save the Facebook pixel ID so we can use it in the facebook pixel JS
                        jQuery.ajax({
                                method: "POST",
                                url: ajaxurl,
                                data: { 'action': 'woosea_elite_save_facebook_pixel_id', 'facebook_pixel_id': facebook_pixel_id }
                        })
                }	
	})
   		...
   		if(this.checked){
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_add_identifiers', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
   		...
   		if(this.checked){
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_enable_structured_data', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_enable_structured_data', 'status': "off" }
                	})
		}
	})	
   		...
   		if(this.checked){
			// Checkbox is on
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_structured_vat', 'status': "on" }
                	})
		} else {
			// Checkbox is off
                	jQuery.ajax({
                        	method: "POST",
                        	url: ajaxurl,
                        	data: { 'action': 'woosea_elite_structured_vat', 'status': "off" }
                	})
		}
	})	
		...
		if (action == "copy"){
			...
			if (popup_dialog == true){
       			jQuery.ajax({
                			method: "POST",
                       	 		url: ajaxurl,
                        		data: { 'action': 'woosea_elite_project_copy', 'project_hash': project_hash }
                		})
		...
		if (action == "trash"){
			...
			if (popup_dialog == true){
        			jQuery.ajax({
                			method: "POST",
                       	 		url: ajaxurl,
                        		data: { 'action': 'woosea_elite_project_delete', 'project_hash': project_hash }
                		})
		...
		if(action == "cancel"){
			...
			if (popup_dialog == true){
        			jQuery.ajax({
                			method: "POST",
                       	 		url: ajaxurl,
                        		data: { 'action': 'woosea_elite_project_cancel', 'project_hash': project_hash }
                		})
		...
		if (action == "refresh"){
			...
			if (popup_dialog == true){
        			jQuery.ajax({
                			method: "POST",
                       	 		url: ajaxurl,
                        		data: { 'action': 'woosea_elite_project_refresh', 'project_hash': project_hash }
                		})
	...
	function woosea_check_perc(){
		...
		$("table tbody").find('input[name="manage_record"]').each(function(){
			...
			jQuery.ajax({
				method: "POST",
                      	 	url: ajaxurl,
                       		data: { 'action': 'woosea_elite_project_processing_status', 'project_hash': hash },
