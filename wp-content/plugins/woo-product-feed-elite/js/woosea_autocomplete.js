...
"5644 - Vehicles & Parts > Vehicles > Watercraft > Yachts",
		...
		jQuery.ajax({
                	method: "POST",
                        url: ajaxurl,
                       	data: { 'action': 'woosea_elite_add_mass_cat_mapping', 'project_hash': project_hash, 'catMappings': toAjax  }
                })
			...
			if (len >= minimum){
				if ( !isNaN(parseInt(map_to_category)) ) {
					...
					jQuery.ajax({
                        			method: "POST",
                        			url: ajaxurl,
                       	 			data: { 'action': 'woosea_elite_add_cat_mapping', 'rowCount': rowCount, 'map_to_category': map_to_category, 'className': className, 'project_hash': project_hash, 'criteria': criteria  }
                			})
